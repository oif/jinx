...
async function registerBotCommands(bot: Bot): Promise<void> {
  try {
    await bot.api.setMyCommands([
      ...
      { command: "task", description: "Inject task to front of queue: /task <desc>" },
      { command: "now", description: "Inject task and trigger immediately: /now <desc>" },
      { command: "abort", description: "Abort current running evolution" },
      { command: "evolve", description: "Trigger evolution (next pending task)" },
      { command: "backlog", description: "Show pending tasks" },
      { command: "history", description: "Show health history" },
      { command: "evolution", description: "Show evolution history" },
      { command: "recent", description: "Show recent 5 evolutions" },
