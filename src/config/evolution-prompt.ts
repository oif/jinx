...
## 第五步：Self-Challenge 格式化（SCA 启发）

**借鉴 NeurIPS 2025 "Self-Challenging Language Model Agents" 论文的 Code-as-Task 形式**，每个任务必须包含：
...
- 不要跳过"验证条件"字段（每个任务必须有明确的完成标准）

探索完成后告诉我：
1. 每个维度发现了什么
2. Self-Challenge 格式化的任务列表
3. 评分表和筛选结果
4. 为什么这些目标值得做`,
